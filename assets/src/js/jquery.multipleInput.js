...
<<<<<<< HEAD
			...
			if(settings.in_flag === true){	
				$wrapper.on('click', '.js-input-plus-in', function (e) {
					e.preventDefault();
...
>>>>>>> origin/master
            ...
            var intervalID = setInterval(function(){
                if (typeof form.data('yiiActiveForm') === 'object') {
                    ...
                    $wrapper.data('multipleInput').currentIndex = $wrapper.find('tr.multiple-input-list__item').length;
					$wrapper.data('multipleInput').currentIndex_in = $wrapper.find('.multiple-input-list-in__item').length;
...
>>>>>>> origin/master
			...
			template = template.replaceAll('value="0"', 'value="'+data.currentIndex+'"');
...
<<<<<<< HEAD
			...
			for (i in settings.jsTemplates2) {
				 jsTemplate2 = settings.jsTemplates2[i]
					.replaceAll('{multiple_index_in}', data.currentIndex_in);	
                window.eval(jsTemplate2);  
...
<<<<<<< HEAD
           var $wrapper    = $(this).closest('.multiple-input').first(),				
                ...
                data        = $wrapper.data('multipleInput'),
				settings    = data.settings,				
				template = $wrapperin.data('multipleInput').settings.template,
...
>>>>>>> origin/master
		...
		removeInputIn: function () {
            var $wrapper = $(this).closest('.multiple-input').first(),
                $toDelete = $(this).closest('.multiple-input-list-in__item'),
                count = $('.multiple-input-list-in__item').length,
                data        = $wrapper.data('multipleInput'),
                settings    = data.settings;
